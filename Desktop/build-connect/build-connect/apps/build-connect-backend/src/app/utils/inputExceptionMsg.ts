export const INVALID_FIELD_MSG = (field: string): string =>
  `Please include a valid ${field}`;

export const INVALID_EXISTING_MSG = (field: string): string =>
  `Please enter your ${field}`;

export const INVALID_ALPHA_SPACE_MSG = (field: string): string =>
  `Please include a valid ${field} with alphabets and spaces only`;

export const INVALID_BOOLEAN_MSG = (field: string): string =>
  `Please include a boolean value for ${field}`;

export const INVALID_TIMESTAMP_MSG = (field: string): string =>
...
export const INVALID_LISTING_STATUS_MSG =
  'Listing status can only be "ongoing" or "completed"';
